...
namespace SimonsShapes
{
    ...
    public static class ConstStrings
    {
        ...
        public const string CREATE_PAINTING = "1. Create new painting.";
        public const string LOAD_PAINTING = "2. Load painting from file.";
        ...
        public const string NOT_WHOLE_NUMBER = " is not a whole number.";
